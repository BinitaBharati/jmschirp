...
class QueueBrowser1 {
    ...
    def init(def jmsConnectionName, def queueName1, def usrSession1, def isScrolled1)
    {
    ...
    def inspectQueue(ConnectionFactory queueConnectionFactory, Queue queue)
    {
        ...
        if (isScrolled == 'N')   //fresh call - no scrolling
        {
        ...
        else if (isScrolled == 'Y')//Look up queueDataEnum from session - its a scroll request.
        {
